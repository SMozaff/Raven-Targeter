...
"""PyInstaller spec for Raven-Targeter on Windows (one-file, windowed).
...
Output:
    dist\\Raven-Targeter.exe

No console window: `console=False`. Crash tracebacks go to the
windowed-traceback dialog instead of a terminal.
"""
